 ...
 */
export declare const useHelloLocalStore: import("zustand").UseBoundStore<import("zustand").StoreApi<HelloLocalStore>>;
/**
 * Selector hooks for optimized re-renders
 * Use these instead of accessing the entire store when you only need specific values
 */
export declare const useLocalPressCount: () => number;
export declare const useShowAnimations: () => boolean;
export declare const useCustomGreeting: () => string | null;
